...
#else
Sint64 sdluio_seek (SDL_RWops *context, Sint64 offset, int whence);
size_t sdluio_read (SDL_RWops *context, void *ptr, size_t size,
		size_t maxnum);
size_t sdluio_write (SDL_RWops *context, const void *ptr, size_t size,
		size_t num);
#endif
