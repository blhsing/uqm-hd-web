...
ProcessInput (void)
{
	...
	/* Traditional Chinese distribution change (2026-07-27): Escape ends
	 * only the active Super Melee match and returns to team setup. */
	if (LOBYTE (GLOBAL (CurrentActivity)) == SUPER_MELEE
			&& PulsedInputState.menu[KEY_MENU_EDIT_CANCEL])
